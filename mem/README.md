...
The crontab will run every minute then you can check the log in the `mem_monitor.log`.

## Features

- Monitor system Mem
- Send alarm message when Mem is abnormal
